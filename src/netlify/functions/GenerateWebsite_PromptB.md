...
- copy the sample site literally
...
VISUAL REQUIREMENTS
- Use the provided theme colors throughout the site
- Apply the full palette to gradients, accents, cards, decorative visuals, buttons, and backgrounds
...
If the candidate’s field suggests visual motifs, you may incorporate abstract, tasteful, non-literal visual ideas such as:
- optical beams
- waveforms
- circuit traces
- laboratory geometry
